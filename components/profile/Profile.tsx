...
// ======================================================
// LOCAL SOCIAL ICONS
// Prevents lucide-react Github/Linkedin export errors
// ======================================================
...
const particles = [
  { left: "7%", top: "14%", size: 3, duration: 7 },
  { left: "18%", top: "78%", size: 2, duration: 9 },
  { left: "31%", top: "22%", size: 4, duration: 8 },
  { left: "54%", top: "12%", size: 2, duration: 10 },
  { left: "72%", top: "82%", size: 3, duration: 7 },
  { left: "88%", top: "29%", size: 2, duration: 9 },
  { left: "95%", top: "69%", size: 4, duration: 11 },
];
...
export default function Profile() {
  ...
  const stackRotateY = useTransform(smoothMouseX, [-0.5, 0.5], [-7, 7]);
  const stackRotateX = useTransform(smoothMouseY, [-0.5, 0.5], [7, -7]);
  const stackX = useTransform(smoothMouseX, [-0.5, 0.5], [-8, 8]);
  const stackY = useTransform(smoothMouseY, [-0.5, 0.5], [-6, 6]);
        ...
        <div className="grid items-center gap-20 lg:grid-cols-[0.92fr_1.08fr] lg:gap-14 xl:gap-24">
          ...
          >
            ...
            <div className="mt-9 max-w-xl space-y-6 text-[1.02rem] leading-8 text-slate-300 sm:text-lg">
              <p>
                ...
                scalable web applications, REST APIs, backend services, and
                polished user experiences.
              </p>

              <p>
                My development stack includes Java, Spring Boot, Node.js,
                Express, React, Next.js, TypeScript, databases, and modern
                cloud-based development workflows.
              </p>

              <p>
                I enjoy solving complex problems, learning new technologies,
                and turning ambitious ideas into useful digital products.
              </p>
            </div>
          ...
          >
                ...
                {galleryItems.map((item, index) => {
                  ...
                  return (
                    <motion.button
                      ...
                      initial={false}
                      animate={desktopPositions[position]}
                      transition={{
                        duration: 0.8,
                        ease: [0.22, 1, 0.36, 1],
                      }}
                      whileHover={
                        isActive
                          ...
                          : {
                              scale:
                                desktopPositions[position].scale + 0.025,
                            }
                      }
            ...
            <p className="mt-4 text-center text-xs text-slate-600">
              Drag the active image or use the arrows
            </p>
          </motion.div>
        </div>
      </div>
